...
<template>
  <footer class="footer">
    <div class="container">
      &copy; {{ currentYear }}
      <span class="flex ml-2 mr-2"
        >Created by
        <a href="https://github.com/ngtruongthanh98" class="flex ml-2 mr-2"
          ><svg
            class="w-6 h-6 text-gray-600 hover:text-gray-800 button--github mr-1"
